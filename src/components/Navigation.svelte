...
<nav
	...
	<ul class="grid w-11/12 grid-cols-4">
		<li class="relative flex flex-col items-center {path == '/' ? 'text-emerald-600' : ''}">
		...
		<li class="relative flex flex-col items-center {path == '/about' ? 'text-emerald-600' : ''}">
		...
		<li class="relative flex flex-col items-center {path == '/book' ? 'text-emerald-600' : ''}">

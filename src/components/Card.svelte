...
<div
	...
	<div class="group relative overflow-hidden transition-all ">
		...
		<div
			class="absolute top-0 left-0 z-10 grid h-full w-full place-items-center bg-gray-700 bg-opacity-0 duration-500 group-hover:bg-opacity-50">
			<!-- svelte-ignore a11y-click-events-have-key-events -->
			<div
				on:click={showModal}
				class="cursor-pointer rounded-sm bg-gray-800 bg-opacity-30 p-2.5 opacity-0 duration-500 group-hover:opacity-100 hover:bg-opacity-60">
...
<style lang="scss">
	...
	// }
	// //group-hover/popConfetti:animate-[shakeConfetti_ease-in-out_300ms_1_300ms] transition-all duration-500 ease-in-out group-hover/popConfetti:-top-1/2  group-hover/popConfetti:opacity-100

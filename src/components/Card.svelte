...
<style lang="scss">
	...
	.custom-arrow {
		@apply absolute top-1/2 z-20 grid aspect-square w-6 -translate-y-1/2 cursor-pointer place-items-center rounded-full bg-gray-200 text-gray-800 opacity-0 transition-all hover:opacity-80 group-hover:opacity-80;
	}
</style>

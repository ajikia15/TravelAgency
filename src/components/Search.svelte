...
<div
	...
	<div
		class="relative w-full transition-all before:pointer-events-none before:absolute  before:left-2 before:top-0 before:z-10 before:text-moss-500 before:transition-all before:content-['Where\0020To?'] focus-within:before:-top-3.5 focus-within:before:text-sm {searchQuery.length >
		0

...
<div class="grid w-full -translate-y-1/2 place-items-center">
	<div
		class="grid w-11/12 transform grid-cols-1 flex-row items-center gap-3 rounded-xl bg-moss-400 p-5 text-2xl shadow-md transition duration-500 after:absolute after:left-0 after:-top-[1px] after:h-2 after:w-full  after:rounded-t-xl hover:scale-105 hover:shadow-lg md:grid-cols-[2fr_1fr] xl:w-1/2">

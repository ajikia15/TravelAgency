			...
			<CarouselModal bind:showModal>
				<Carousel
					...
					<div
						...
						class=" appear fixed left-2 top-1/2 z-[1] aspect-square -translate-y-1/2 cursor-pointer p-4 text-white transition-all">
					...
					{#each tour.Pics as pic}
						<img
							class="mainappear aspect-[3/2] h-full w-full bg-transparent md:pointer-events-none"
							loading="lazy"
							alt="tour"
							src={pic} />
					{/each}
					...
					<div
						...
						class="appear fixed right-2 top-1/2 aspect-square -translate-y-1/2 cursor-pointer p-4 text-white">

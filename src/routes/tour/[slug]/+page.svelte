	...
	<div class="grid w-11/12 gap-8 md:grid-cols-[7fr_4fr]" use:autoAnimate>
		...
		<div class="relative flex flex-col space-y-2">
			<div class="flex flex-col space-y-2 top-24 md:sticky">
				{#if tour.Location}
					<div
						class="flex flex-col justify-center w-full space-y-5 text-center bg-white border rounded shadow p-7 will-change-transform">
						<div class="space-y-4">
							<h1 class="text-3xl font-bold">{tour.Location}, Georgia</h1>
							<h3 class="text-sm text-gray-400">Vacation Package</h3>
						</div>
						<ul
							class="grid grid-rows-1 text-left border border-collapse border-gray-100 rounded shadow-sm">
							<li class="flex flex-row items-center p-3 font-semibold border-t gap-x-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="text-gray-800"
									width="24"
							...
							<li class="flex flex-row items-center gap-2 p-3 font-semibold border-t">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="text-gray-800"
									width="24"
							...
							<Accordion type="single" collapsible class="w-full border-t">
								...
								<AccordionItem value="item-2" class="px-3 border-b-0">
									<AccordionTrigger class="py-3"
										><div class="flex flex-row gap-x-2">
											<svg
												xmlns="http://www.w3.org/2000/svg"
						...
						<button
							type="button"
							class="w-full p-2 text-xl text-center transition-all rounded opacity-100 bg-moss-500 text-moss-100 hover:opacity-75"
							>Book</button>
					</div>

		...
		<div class="relative flex flex-col space-y-2">
			<div class="top-24  flex flex-col space-y-2 md:sticky">
				<div
					...
					<button
						type="button"
						class="w-full rounded bg-moss-500 p-2 text-center text-xl text-moss-100 opacity-100 transition-all hover:opacity-75"
						>Book</button>
				</div>
				<div class="grid w-full grid-cols-3 gap-2 rounded text-moss-500">
					<div
						class="group grid place-items-center rounded border bg-white p-2 shadow transition-all hover:bg-moss-500 hover:text-white">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="28"
							height="28"
					...
					<div
						class="group flex items-center justify-center gap-1 rounded border bg-white p-2 shadow transition-all hover:bg-moss-500 hover:text-white">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class=""
							width="28"

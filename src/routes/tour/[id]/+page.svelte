		...
		<div class="relative flex flex-col space-y-2">
			<div class="top-24  flex flex-col space-y-2 md:sticky">
				...
				<div class="grid w-full grid-cols-3 gap-2 rounded text-moss-500">
					<div class="grid place-items-center rounded border bg-white p-2 shadow">
					...
					<a
						...
						class="grid place-items-center rounded border bg-white p-2 shadow">
						<p class="text-xl" aria-label="Contact Phone Number">+995 598 85 73 74</p>
					</a>
					<div class="flex items-center justify-center gap-1 rounded border bg-white p-2 shadow ">
						<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
							><path
								fill="currentColor"
